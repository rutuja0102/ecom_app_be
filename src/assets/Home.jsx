...
function Home() {
  ...
  function getAllProducts() {
    fetch("https://ecom-app-u73g.onrender.com/product/all-products").then(
      (res1) => {
        res1.json().then((res2) => {
          console.log(res2);
                ...
                return (
                  <Col key={i}>
                    ...
                    >
                      <Card.Img
                        variant="top"
                        src={`https://ecom-app-u73g.onrender.com/product/product-photo/${p._id}`}
                        className="img-fluid mx-auto d-block h-50 w-100"
                      />
                      <Card.Body>
